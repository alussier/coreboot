...
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_Q670	0x7a83
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_Z690	0x7a84
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_H670	0x7a85
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_B660	0x7a86
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_H610	0x7a87
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_W680	0x7a88
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_HM670	0x7a8c
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_WM690	0x7a8d
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_N		0x5481
...
#define PCI_DEV_HAS_ME_DIFFICULT(x) ( \
	...
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_Q670) || \
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_Z690) || \
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_H670) || \
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_B660) || \
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_H610) || \
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_W680) || \
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_HM670) || \
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_WM690) || \
	((x) == PCI_DEVICE_ID_INTEL_ALDERLAKE_N) || \
	0)
...
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_CSME1 0x7AE8 /* Alder Lake #1 */
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_CSME2 0x7AE9 /* Alder Lake #2 */
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_CSME3 0x7AEC /* Alder Lake #3 */
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_CSME4 0x7AED /* Alder Lake #4 */
#define PCI_DEVICE_ID_INTEL_ALDERLAKE_N_CSE1 0x54E0 /* Alder Lake #4 */
...
#define PCI_DEV_HAS_SUPPORTED_ME(x) ( \
	...
	((x) ==  PCI_DEVICE_ID_INTEL_ALDERLAKE_CSME1) || \
	((x) ==  PCI_DEVICE_ID_INTEL_ALDERLAKE_CSME2) || \
	((x) ==  PCI_DEVICE_ID_INTEL_ALDERLAKE_CSME3) || \
	((x) ==  PCI_DEVICE_ID_INTEL_ALDERLAKE_CSME4) || \
	((x) ==  PCI_DEVICE_ID_INTEL_ALDERLAKE_N_CSE1) || \
	0)
